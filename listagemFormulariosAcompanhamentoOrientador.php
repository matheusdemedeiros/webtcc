    ...
    <?php
       ...
       <h5>
            ...
            <div class="container">
                ...
                href="editarFormularioAcompanhamentoOrientador.php?editaid=<?=$formulario['id']?>"><i class="material-icons right">edit</i>Editar</a>
                <a class="waves-effect  green accent-3 btn" 
                onclick="excluirFormularioAcompanhamentoOrientador(<?=$formulario['id']?>)"><i class="material-icons right">delete</i>Excluir</a>
            </div>
