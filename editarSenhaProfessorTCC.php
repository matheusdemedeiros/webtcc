...
<body>
    <?php 
		$cabecalho_title = "Editar Senha Professor de TCC";
		include("cabecalho.php");
        include("conecta.php");
        $recid = $_GET['editaid'];
        $seleciona = mysqli_query($conexao, "SELECT * FROM termpaperteacher INNER JOIN
        users WHERE IdTermPaperTeacher = '$recid' AND IdUser=UserId");
        $campo = mysqli_fetch_array($seleciona);
		?>
    <div class="container">
        <form class="container" name="formuser" action="gravaEditaSenhaProfessorTCC.php" method="POST">
