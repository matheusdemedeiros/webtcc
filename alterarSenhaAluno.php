...
<body>
    <?php 
		$cabecalho_title = "Editar Senha Aluno";
		...
		?>
    <div class="container">
        <form class="container" name="formuser" action="gravaEditaAlterarSenhaAluno.php" method="POST">

            <fieldset class="container">
                <h5>Edição de Orientador</h5>
                <input type="hidden" name="id" value="<?=$campo["IdStudent"]?>">
